...
export default function works() {
  return (
    <div className=" flex items-center justify-center h-auto sm:h-[86vh] xl:h-auto p-4 ">
      <div className=" w-[100%] xl:w-4/6 h-auto mb-10 pb-10 flex p-3 flex-col sm:flex-row">
        ...
        <div className="w-full sm:w-4/5">
          <div className="w-full   flex flex-col justify-between py-4">
            <h3 className="text-white text-4  xl:text-5xl flex justify-center items-center ">
          ...
          <div className="flex gap-3 mb-5 ">
            <Container2 data={{ images: project3, text1: "SHOWCASE", text2: "PROJECT" }} />
