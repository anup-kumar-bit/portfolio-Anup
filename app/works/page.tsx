      ...
      <div className=" w-[100%] xl:w-4/6 h-auto mb-10 pb-10 flex p-3 flex-col sm:flex-row">
        ...
        <div className="w-full sm:w-4/5">
          ...
          <div className="flex gap-3 mb-5 flex-col sm:flex-row">
            <Container2 data={{ images: project3, text1: "Blog website -astro", text2: "PROJECT" ,link:"https://blogverse-anup-kumar-bit.netlify.app/" }} />
            <Container2 data={{ images: project4, text1: "Invoice Generator -React.js Gsap", text2: "PROJECT" , link:"https://github.com/anup-kumar-bit/bill"}} />
          </div>
          <div className="flex gap-3 mt-5 flex-col sm:flex-row">
            <Container2 data={{ images: project5, text1: "SHOWCASE", text2: "PROJECT" , link:"https://github.com/anup-kumar-bit/bill"}} />
            <Container2 data={{ images: project6, text1: "UNKNOWN-WORKING", text2: "PROJECT", link:"https://github.com/anup-kumar-bit/currency"}} />
          </div>
        </div>
      </div>
    </div>
