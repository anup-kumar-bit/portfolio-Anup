...
export default function ContainerAbout({images}: BigcontainerProps){
    ...
    return (
        <div  className=" bg-gradient-to-r from-[#19191be3] via-[#141413f1] to-[#111111] w-[80%] md:w-[50%] xl:w-[32%]  xl:h-[100%] rounded-3xl flex p-5 items-center justify-center gap-3
