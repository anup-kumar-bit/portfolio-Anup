...
export default function Container2({ data }: BigcontainerProps) {
    ...
    return (
        <div 
            data-aos="zoom-in" 
            className="bg-gradient-to-r from-[#19191b] via-[#141413] to-[#111111] shadow-[3px_6px_17px_2px_rgba(0,_0,_0,_0.7)] rounded-2xl flex flex-col items-center justify-evenly cursor-pointer"
            style={{ width: Wid }}
        >
            <a
                href={data.link}
            ...
            >
                <Image 
                    src={data.images.src} 
                    alt="sign" 
                    width={data.w ?? data.images.width} 
                    height={data.h ?? data.images.height}
